...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_unidim");
    ...
    reader.add_event(14, 1, "restart", "model_unidim");
    ...
    reader.add_event(94, 3, "restart", "model_unidim");
    reader.add_event(153, 60, "end", "model_unidim");
    return reader;
}
...
class model_unidim
  : public stan::model::model_base_crtp<model_unidim> {
private:
...
typedef model_unidim_namespace::model_unidim stan_model;
#ifndef USING_R
