...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_factor_ll");
    ...
    reader.add_event(14, 1, "restart", "model_factor_ll");
    ...
    reader.add_event(94, 3, "restart", "model_factor_ll");
    reader.add_event(297, 204, "end", "model_factor_ll");
    return reader;
}
...
class model_factor_ll
  : public stan::model::model_base_crtp<model_factor_ll> {
private:
...
typedef model_factor_ll_namespace::model_factor_ll stan_model;
#ifndef USING_R
