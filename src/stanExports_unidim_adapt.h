...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_unidim_adapt");
    ...
    reader.add_event(14, 1, "restart", "model_unidim_adapt");
    ...
    reader.add_event(94, 3, "restart", "model_unidim_adapt");
    reader.add_event(154, 61, "end", "model_unidim_adapt");
    return reader;
}
...
class model_unidim_adapt
  : public stan::model::model_base_crtp<model_unidim_adapt> {
private:
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "varCorrection", "double", context__.to_vec());
            varCorrection = double(0);
            vals_r__ = context__.vals_r("varCorrection");
            pos__ = 0;
            varCorrection = vals_r__[pos__++];
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> theta(NPA);
            stan::math::initialize(theta, DUMMY_VAR__);
            stan::math::fill(theta, DUMMY_VAR__);
            stan::math::assign(theta,multiply(stan::math::sqrt(sigma), rawTheta));
            ...
            stan::math::assign(scale,pow(sd(theta), varCorrection));
            ...
            stan::math::assign(maxSpan,(max(theta) - min(theta)));
            ...
            for (int rx = 1; rx <= numRefresh; ++rx) {
                ...
                lp_accum__.add(pairwise_logprob(rcat, weight, cmpStart, get_base1(refresh, rx, "refresh", 1), scale, alpha, get_base1(theta, get_base1(pa1, rx, "pa1", 1), "theta", 1), get_base1(theta, get_base1(pa2, rx, "pa2", 1), "theta", 1), rawCumTh, pstream__));
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            double thetaVar;
            (void) thetaVar;  // dummy to suppress unused var warning
            stan::math::initialize(thetaVar, DUMMY_VAR__);
            stan::math::fill(thetaVar, DUMMY_VAR__);
            stan::math::assign(thetaVar,variance(theta));
            // validate, write generated quantities
            current_statement_begin__ = 151;
            vars__.push_back(thetaVar);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
typedef model_unidim_adapt_namespace::model_unidim_adapt stan_model;
#ifndef USING_R
