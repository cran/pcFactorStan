...
#include "stanExports_unidim_adapt.h"

RCPP_MODULE(stan_fit4unidim_adapt_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_unidim_adapt")
