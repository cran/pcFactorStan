...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_factor1_ll");
    ...
    reader.add_event(14, 1, "restart", "model_factor1_ll");
    ...
    reader.add_event(94, 3, "restart", "model_factor1_ll");
    reader.add_event(287, 194, "end", "model_factor1_ll");
    return reader;
}
...
class model_factor1_ll
  : public stan::model::model_base_crtp<model_factor1_ll> {
private:
...
typedef model_factor1_ll_namespace::model_factor1_ll stan_model;
#ifndef USING_R
