...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_correlation");
    ...
    reader.add_event(14, 1, "restart", "model_correlation");
    ...
    reader.add_event(94, 3, "restart", "model_correlation");
    reader.add_event(179, 86, "end", "model_correlation");
    return reader;
}
...
class model_correlation
  : public stan::model::model_base_crtp<model_correlation> {
private:
...
typedef model_correlation_namespace::model_correlation stan_model;
#ifndef USING_R
